              ...
              {showLogo && (
                <motion.div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: `<lottie-player src="https://assets.kadamproduction.in/Scene-1-2_kyav4b.json" background="transparent" speed="1" style="width: 100%; height: 100%;" loop autoplay></lottie-player>`
                  }}
                />
              )}
            </AnimatePresence>
