              ...
              {showLogo && (
                <motion.div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: `<lottie-player src="https://vrwhhajqjsrkripwalfp.supabase.co/storage/v1/object/public/assets/Scene-1-2_kyav4b.json" background="transparent" speed="1" style="width: 100%; height: 100%;" loop autoplay></lottie-player>`
                  }}
                />
              )}
            </AnimatePresence>
